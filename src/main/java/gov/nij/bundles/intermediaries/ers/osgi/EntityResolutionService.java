...
/**
 * An OSGi service that provides the ability to resolve "entities". The
 * interface closely follows the Stanford SERF toolkit.
 * 
 */
public class EntityResolutionService {
	 ...
	 *            The information needed to control the resolution (algorithm,
	 *            merge threshold, determinativeness)
	 * @return A set of records with merged entities and a set of statistics for
	 *         the merge
	 * @throws Exception
	 */
	public EntityResolutionResults resolveEntities(List<RecordWrapper> recordWrappers, Set<AttributeParameters> attributeParameters) throws Exception {
		...
		List<ExternallyIdentifiableRecord> returnRecordList = new ArrayList<ExternallyIdentifiableRecord>();
		...
		Map<String, Set<AttributeStatistics>> statistics = computeStatistics(returnRecords, attributeParameters);
		EntityResolutionResults ret = new EntityResolutionResults(EntityResolutionConversionUtils.convertRecords(returnRecordList), statistics);
		return ret;
	}
	...
	/*
	 * This method compare two deterministic factor maps. If at anytime it finds
	 * a difference, it breaks and returns false
	 * 
	...
	/*
	 * This method will return a map of the deterministic factors for a
	 * particular record
	 * 
	...
	/*
	 * This method will return a set of the names of values that are
	 * deterministic. We can later check this array in the deterministic factors
	 * algorithm to see what the deterministic factors are.
	 * 
	 * @param attributeParameters
	 * @return
	 */
	...
	private Map<String, Set<AttributeStatistics>> computeStatistics(Set<ExternallyIdentifiableRecord> records, Set<AttributeParameters> attributeParameters) {
